...
class Predictor(BasePredictor):
    ...
    def generate(self,
        ...
        for crop_region, layer_idx in zip(crop_regions, layer_idxs):
            ...
            crop_im = F.interpolate(im[..., y1:y2, x1:x2], (ih, iw), mode='bilinear', align_corners=True)
            # (num_points, 2)
            ...
            for (points, ) in batch_iterator(points_batch_size, points_for_image):
                ...
                pred_mask = F.interpolate(pred_mask[None], (h, w), mode='bilinear', align_corners=True)[0]
